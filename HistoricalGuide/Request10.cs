...
{
    public partial class Request10 : Form
    {
        public Request10()
        {
            InitializeComponent();
        ...
        private void createColums()
        {
            ...
            dataGridView1.Columns.Add("amount_event", "Кількість подій в яких брала участь ця історична особистість");
        ...
        private void refreshDataGrid(DataGridView dgw)
        {
            ...
            MySqlCommand command = new MySqlCommand("amount_event_for_person", historicalguide.getConnection());
        ...
        private void Request10_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            Hide();
        }
